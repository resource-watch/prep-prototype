...
module.exports = function(environment) {
  var ENV = {
    ...
    contentSecurityPolicy: {
      ...
      'connect-src': "'self' http://*.cartodb.com http://arcgis-sdgs-385255865.us-east-1.elb.amazonaws.com/ http://*.arcgis.com/ http://services.arcgisonline.com/ https://sdg-api.herokuapp.com/ http://localhost:3000 https://*.esri.com",
      'img-src': "'self' blob: data: http://*.cartocdn.com http://*.cartodb.com https://api.tiles.mapbox.com https://s3.amazonaws.com http://arcgis-sdgs-385255865.us-east-1.elb.amazonaws.com/ https://*.arcgis.com/ http://*.arcgis.com/ http://*.arcgisonline.com/ https://*.esri.com",
