...
module.exports = function(environment) {
  var ENV = {
    ...
    contentSecurityPolicy: {
      ...
      'connect-src': "'self' https://*.cartodb.com http://arcgis-sdgs-385255865.us-east-1.elb.amazonaws.com/ http://*.arcgis.com/ http://services.arcgisonline.com/ https://sdg-api.herokuapp.com/ http://localhost:3000 https://*.esri.com",
